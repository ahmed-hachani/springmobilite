...
public class MoyenneDTO {
    ...
    public void updateMoyenne(Long formId, Long userId, FormRepository formRepository,
    ...
    private double calculateAverageForUser(Long formId, Long userId, FormRepository formRepository,
                                           FormFieldRepository formFieldRepository,
                                           FormDataRepository formDataRepository) {
